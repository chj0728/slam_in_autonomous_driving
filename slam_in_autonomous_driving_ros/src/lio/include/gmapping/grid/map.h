...
public:
    ...
    // void set(const Point &center, double xmin, double ymin, double xmax, double ymax, double delta);
    //重新设置地图大小
    void resize(const double &xmin, const double &ymin, const double &xmax, const double &ymax);
...
// template <class Cell, class Storage, const bool isClass>
// void Map<Cell, Storage, isClass>::set(const Point &center, double xmin, double ymin, double xmax, double ymax, double delta) : m_storage((int)ceil((xmax - xmin) / delta), (int)ceil((ymax - ymin) / delta))
// {
//     m_center = center;
//     m_worldSizeX = xmax - xmin;
//     m_worldSizeY = ymax - ymin;
...
template <class Cell, class Storage, const bool isClass>
void Map<Cell, Storage, isClass>::resize(const double &xmin, const double &ymin, const double &xmax, const double &ymax)
{
